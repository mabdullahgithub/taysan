...
<div class="container-fluid">
    ...
    <div class="hk-pg-header">
        ...
        <div class="d-flex">
            ...
            <a href="{{ route('admin.announcements.show', $announcement) }}" class="btn btn-info">
                ...
                <form action="{{ route('admin.announcements.update', $announcement) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('type') is-invalid @enderror" 
                                            ...
                                            <option value="sale" {{ old('type', $announcement->type) == 'sale' ? 'selected' : '' }}>Sale</option>
                                            <option value="announcement" {{ old('type', $announcement->type) == 'announcement' ? 'selected' : '' }}>Announcement</option>
                                            <option value="countdown" {{ old('type', $announcement->type) == 'countdown' ? 'selected' : '' }}>Countdown</option>
                                            <option value="product_launch" {{ old('type', $announcement->type) == 'product_launch' ? 'selected' : '' }}>Product Launch</option>
                            ...
                            <!-- Design & Action Settings -->
                            <div class="card mb-4">
                                <div class="card-header">
                                    <h5 class="card-title">Design & Action Settings</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="color" 
                                                       ...
                                                       value="{{ old('background_color', $announcement->background_color ?? '#8B7BA8') }}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="color" 
                                                       ...
                                                       id="text_color" 
                                                       name="text_color" 
                                                       value="{{ old('text_color', $announcement->text_color ?? '#FFFFFF') }}">
                                                @error('text_color')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" 
                                               ...
                                               id="countdown_date" 
                                               name="countdown_date" 
                                               value="{{ old('countdown_date', $announcement->countdown_date ? $announcement->countdown_date->format('Y-m-d\TH:i') : '') }}">
                                        @error('countdown_date')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <small class="form-text text-muted">Set a countdown timer for this announcement</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            @if($announcement->image)
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <img src="{{ $announcement->image }}" alt="Current Image" class="img-fluid rounded">
                                        <div class="mt-2">
                            ...
                            <div class="card mb-4">
                                <div class="card-header">
                                    <h5 class="card-title">{{ $announcement->image ? 'Replace' : 'Upload' }} Image</h5>
                                </div>
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="image" class="form-label">{{ $announcement->image ? 'New Image' : 'Upload Image' }}</label>
                                        <input type="file" 
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" 
                                               ...
                                               id="order" 
                                               name="order" 
                                               value="{{ old('order', $announcement->order) }}" 
                                               min="0">
                                        @error('order')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" 
                                               ...
                                               value="{{ old('display_duration', $announcement->display_duration ?? 5000) }}" 
                                               min="1000">
                                        @error('display_duration')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <small class="form-text text-muted">How long to display this slide (in milliseconds)</small>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body text-right">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fa fa-save mr-2"></i>Update Announcement
                                    </button>
                                </div>
                            </div>
                        </div>
