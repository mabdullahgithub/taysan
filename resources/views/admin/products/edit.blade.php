                    ...
                    @if($product->image)
                        ...
                        <div class="current-image-container" id="currentImageContainer">
                            <img src="{{ $product->image_url ?? asset('storage/' . $product->image) }}" 
                                 ...
                                 class="current-image"
                                 onerror="this.style.display='none'; document.getElementById('imageErrorMessage').style.display='block';">
                        ...
                        <div id="imageErrorMessage" style="display: none;" class="alert alert-warning">
                            <i class="fas fa-exclamation-triangle"></i>
                            Current image could not be loaded. Please upload a new image.
                        </div>
                        <div class="text-muted mb-3">
                            <small>Current image: {{ $product->image }}</small><br>
                            <small>Full path: {{ asset('storage/' . $product->image) }}</small><br>
